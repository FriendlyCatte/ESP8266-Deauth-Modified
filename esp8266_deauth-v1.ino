// SCROLL DOWN TO void setup() TO SEE CREDITS
...
void setup() {
  // THIS SCRIPT IS A MODIFIED VERSION OF SPACEHUHN'S SCRIPT,I DONT OWN
  // ANYTHING IN THIS SCRIPT
  
  
  // --Info--
  // This Code Is A Modified Version Of Clang,Do Not Run This In A Orginal Clang Enviroment
  // It Will Not Work, Also,This Code Only Work With NodeMCU Board,Which Use ESP32 NodeMCU
  // Or ESP8266 NodeMCU, etc...
  // --Syntax Notice--
  // In NodeMCU Clang Enviroment,Do Not Use Any Other Syntax To Pause The Code
  // In NodeMCU,delay(); Is The Only Syntax Used To Pause Code
  // To Define Pin, Use pinMode(); To Set Pin Mode
  // Example 1: pinMode(internalLED, OUTPUT);
  //                         |          |
  //                         |          | Pin Mode (Currently Output At Pin D0)
  //                         | String
  // Example 2: pinMode(internalLED, INPUT);
  //                         |          |
  //                         |          | Pin Mode (Currently Input At Pin D0)
  //                         | String
...
void loop() {
    // Is the device is online or not 
    delay(500);
      digitalWrite(internalLED, LOW);
      digitalWrite(blueLED, LOW);
    delay(500);
    ...
    // --Meaning--
    // Blinking: Online
    // Long Delayed Blinking: Starting Device
    // Static Off: Offline Or Corrupted Code
    // Static On: Problems With Sketch Or Corrupted Code
